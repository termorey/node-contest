...
export const ContestCreation = () => {
  ...
  return (
    <form
      ...
      className={"flex flex-col justify-start items-stretch gap-6"}
    >
      <FieldsRow columns={3}>
        <Field>
        ...
        <Field>
          ...
          <NumberInput
            name={"fieldSizeX"}
            min={3}
            defaultValue={defaultValues.fieldSizeX}
          />
        </Field>
        <Field>
          <span>{"y [px]"}</span>
          <NumberInput
            name={"fieldSizeY"}
            min={3}
            defaultValue={defaultValues.fieldSizeY}
          />
        </Field>
      </FieldsRow>
      <FieldsRow columns={3}>
        ...
        <Field>
          ...
          <NumberInput
            name={"fieldsCountX"}
            min={3}
            defaultValue={defaultValues.fieldsCountX}
          />
        </Field>
        <Field>
          <span>{"y [number]"}</span>
          <NumberInput
            name={"fieldsCountY"}
            min={3}
            defaultValue={defaultValues.fieldsCountY}
          />
        </Field>
      </FieldsRow>
      {Object.keys(errors).map((field) => (
        ...
        >{`Error: ${errors[field as keyof typeof errors]}`}</span>
      ))}
...
}> = ({ name, onChange, min, defaultValue }) => (
  <input
    className={input()}
    name={name}
    type={"number"}
